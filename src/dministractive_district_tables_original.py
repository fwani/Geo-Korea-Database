...
def create_tables(cur, home):
    # create tables
    print("Create tables")
    cur.execute(open(os.path.join(home, 'sql/create_dministractive_district_tables_original.sql'), 'r').read())

def insert_datas(cur, home):
    # create tables
    print("insert data")
    cur.execute(open(os.path.join(home, 'sql/insert_dministractive_district_tables_original.sql'), 'r').read())
